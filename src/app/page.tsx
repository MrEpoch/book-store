  ...
  return (
      ...
      sm:px-6 lg:px-8 flex flex-col gap-3 pt-[10rem]">
                <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                    <h1 className="dark:text-white mb-4 text-4xl font-extrabold tracking-tight p-3
      leading-none text-gray-900 md:text-5xl lg:text-6xl "><span className="
      bg-gradient-to-br from-green-500 to-cyan-300 bg-clip-text text-transparent box-decoration-clone
      ">Acnowledge,</span> and seek truth!</h1>
      ...
      strokeWidth="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
            ...
            <div className="relative">
                <div className="text-green-500 custom-shape-divider-top-1695639847">
                    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
                        <path fill="currentColor" d="M1200,0H0V120H281.94C572.9,116.24,602.45,3.86,602.45,3.86h0S632,116.24,923,120h277Z" >
                        </path>
                    </svg>
                </div>
            </div>
