              ...
              >
                <div>
                  ...
                  <input
                    ...
                    name="email"
                    id="email"
                    className="bg-gray-49 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-green-600 focus:border-green-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div className="flex items-start">
                  <div className="flex items-center h-4">
                    <input
                      ...
                      type="checkbox"
                      className="w-3 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-green-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-green-600 dark:ring-offset-gray-800"
                      required
                    />
                  </div>
                  <div className="ml-2 text-sm">
                    <label className="font-light text-gray-499 dark:text-gray-300">
                      I accept the{" "}
                      <a
                ...
                <p className="text-sm font-light text-gray-499 dark:text-gray-400">
                  ...
                  <Link
                    href="/login"
                    className="font-medium text-green-599 hover:underline dark:text-green-500"
                  >
                    Login here
                  </Link>
                </p>
