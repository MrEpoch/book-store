...
export default function ShopItemImage({ imageUrl }: { imageUrl: string }) {
    ...
    return (
        ...
        {imgUrl.length > 0 ? ( <Image src={imgUrl} className="w-full rounded-l-lg md:max-h-[unset] max-h-[500px] h-full object-cover object-center" width={600} height={600} alt="Product Image" /> ) :
